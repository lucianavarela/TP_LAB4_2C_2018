...
export class EmpleadoService {
  ...
  public activar(objeto) {
    return this.miHttp.post(this.ruta + 'activar', objeto)
      .then(data => {
        if (data.status == "OK") {
          location.reload();
        } else {
  ...
  public deshabilitar(objeto) {
    return this.miHttp.post(this.ruta + 'deshabilitar', objeto)
      .then(data => {
        if (data.status == "OK") {
          location.reload();
        } else {
